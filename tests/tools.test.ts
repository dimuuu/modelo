...
/**
 * Every tool runs here against an in-memory editor and an in-memory
 * workspace. No React, no BlockNote, no DOM.
 */
function harness(
...
/** The shape a mutating tool returns, plus whatever the tool adds. */
interface ToolData {

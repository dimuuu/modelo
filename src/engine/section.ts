...
/**
 * A section is the unit an agent writes: a heading, prose that mentions
 * variables by `@name`, and the inputs and formulas those mentions resolve to.
 */
...
/**
 * What an agent may set on an input: the stored fields, with currency and
 * unit narrowed to the curated lists and no locale override.
 */

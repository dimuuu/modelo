...
/**
 * Walks the document once. The first block to claim a name or an id keeps it;
 * a later claimant becomes an issue instead of poisoning the whole document.
 */
...
/**
 * Projects a document into the variable registry, keeping every invalid
 * block as an issue. One broken block never hides the rest of the model.
 */

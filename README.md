...
To build a new model, ask ChatGPT to `write_section` rather than dump variables. Use typed `insert_blocks` only for targeted block surgery; paragraph `@name` tokens become live references.
